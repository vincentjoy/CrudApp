...
export default function EditScreen() {
    ...
    const handleSave = async () => {
        try {
            ...
            if (storageTodos && storageTodos.length) {
                const otherTodos = storageTodos.filter(todo => todo.id !== savedTodo.id) // Filter out the old todo
            ...
            router.push('/') // Going back to previous screen
        } catch (e) {
            console.error(e)
        }
    }
...
function createStyles(theme, colorScheme) {
    return StyleSheet.create({
        ...
        input: {
            ...
            minWidth: 0, // To let the input shrink, if needed, for small screens
            color: theme.text,
        },
        saveButton: {
